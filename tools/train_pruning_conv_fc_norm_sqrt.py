...
def parse_args():
    ...
    parser.add_argument('--config', default='../configs/resnet/resnet32/resnet32_pruning_cifar10.py', help='train config file path')
    parser.add_argument('--work-dir', default='../result/temp',  help='the dir to save logs and models')
    parser.add_argument(
